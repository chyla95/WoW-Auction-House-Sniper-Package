...
const fetchItemById = (id, localization) => __awaiter(void 0, void 0, void 0, function* () {
    const requestPath = `${configuration_battle_net_1.configurationBattleNetApi.apiDomain(localization.region)}/data/wow/item/${id}`;
    ...
    if (!responseRaw)
        return;
    return new item_1.Item(responseRaw);
});
